                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form  method="POST" action="{{route('pengumumanAdmin.store')}}" class="pl-3 pr-3" enctype="multipart/form-data">
                                    @csrf
                        ...
                        <table id="myTable" class="table table-striped table-bordered no-wrap">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <a href="{{route('pengumumanAdmin.edit',$pengumumans->id)}}"  class="btn waves-effect waves-light btn-warning">
                                       EDIT
                                    </a>
